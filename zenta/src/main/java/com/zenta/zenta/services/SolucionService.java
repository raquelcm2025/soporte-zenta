...
public class SolucionService {
    ...
    public List<Solucion> obtenerPorTicket(Ticket ticket) {
        return solucionRepository.findByTicket(ticket);
    }
    public List<Solucion> obtenerTicketsConSolucion() {
        return solucionRepository.findByTicket_Estado("Concluido");
    }
